...
<body>
    <form id="form1" runat="server">
        ...
        <br /><br />
        <asp:Label ID="lblFirstName" runat="server" Text="First Name:" AssociatedControlID="txtFirstName"></asp:TextBox>
        <asp:TextBox ID="txtFirstName" runat="server" ReadOnly="true"></asp:TextBox>
        <br /><br />
        <asp:Label ID="lblLastName" runat="server" Text="Last Name:" AssociatedControlID="txtLastName"></asp:TextBox>
        <asp:TextBox ID="txtLastName" runat="server" ReadOnly="true"></asp:TextBox>
        <br /><br />
        <asp:Label ID="lblEmail" runat="server" Text="Email:" AssociatedControlID="txtEmail"></asp:TextBox>
        <asp:TextBox ID="txtEmail" runat="server" ReadOnly="true"></asp:TextBox>
        <br /><br />
        <asp:Label ID="lblPhone" runat="server" Text="Phone:" AssociatedControlID="txtPhone"></asp:TextBox>
        <asp:TextBox ID="txtPhone" runat="server" ReadOnly="true"></asp:TextBox>
        <br /><br />
        <asp:Label ID="lblRole" runat="server" Text="Role:" AssociatedControlID="txtRole"></asp:TextBox>
        <asp:TextBox ID="txtRole" runat="server" ReadOnly="true"></asp:TextBox>
        <br /><br />
        <asp:Label ID="lblIsActive" runat="server" Text="Is Active:" AssociatedControlID="chkIsActive"></asp:CheckBox>
